...
<div class="text-center py-12 bg-white rounded-lg shadow-sm" data-aos="fade-up">
    ...
    @if($buttonText && $buttonLink)
        <a href="{{ $buttonLink }}" class="inline-block text-xl font-semibold py-2 px-12 rounded-full bg-pinkButton text-white border-none transition-all duration-100 ease-in-out hover:scale-105 hover:shadow-[0_4px_12px_rgba(0,0,0,0.2)]">
