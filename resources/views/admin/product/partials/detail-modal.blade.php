<div id="detailModal" class="fixed inset-0 flex items-center justify-center z-50 p-4 opacity-0 pointer-events-none transition-opacity duration-300">
  ...
  <div id="detailModalContent" class="bg-white rounded-xl shadow-lg w-full sm:max-w-md md:max-w-3xl max-h-screen overflow-auto relative transform scale-95 opacity-0 transition-all duration-300">
    <div class="flex justify-between items-center p-4 border-b bg-pinkBg text-white rounded-t-xl">
    ...
    <div class="p-6 grid md:grid-cols-2 gap-6">
      ...
      <div>
        <table class="w-full text-left">
          ...
          <tr><th class="text-gray-400 align-top">Deskripsi</th><td id="detail-description" class="wrap-break-word"></td></tr>
        </table>
      </div>
    </div>
  </div>
